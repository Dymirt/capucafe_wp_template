	...
	<div class='  text-white relative z-10 w-full'>
		...
		<div class='subsections  flex items-center  text-sm max-xl:text-[12px]  max-lg:text-[10px] h-[40vh] max-md:w-full'>
			<div class='flex flex-wrap w-full max-md:justify-center'>
				...
				<a href="<?php echo esc_url(get_permalink(wc_get_page_id('shop'))); ?>" class='text-white features-sec w-[23%] max-md:w-[45%] max-md:mb-2 px-4 mr-[2%] h-16 flex items-center justify-between'>Sklep online <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
