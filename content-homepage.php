	...
	<div class='  text-white relative z-10 w-full'>
					...
					<div class='subsections  flex items-center  text-sm max-xl:text-[12px]  max-lg:text-[10px] h-[40vh] max-md:w-full'>
						<div class='flex flex-wrap w-full max-md:justify-center'>
							<span class='features-sec w-[23%] max-md:w-[45%] max-md:mb-2 px-4 mr-[2%] h-16 flex items-center justify-between'> <span>Pracownia tortów </span>	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
							...
							<span class='features-sec w-[23%]  max-md:w-[45%] max-md:mb-2 px-4 mr-[2%] h-16 flex items-center justify-between'><span>Słodkie Stoły</span><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<span class='features-sec w-[23%] max-md:w-[45%] max-md:mb-2 px-4 mr-[2%] h-16 flex items-center justify-between'><span>Kawiarnie</span><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<span class='features-sec w-[23%] max-md:w-[45%] max-md:mb-2 px-4 mr-[2%] h-16 flex items-center justify-between'>Sklep online 	<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="flex relative max-md:flex-col z-10 max-sm:pt-8 max-md:pt-36  pt-48 max-sm:w-full max-md:w-[80%] max-lg:w-[90%]  max-xl:w-[85%] max-2xl:w-[85%]">
	<div id="mssg" class="title text-black max-md:w-full w-2/5 max-lg:w-1/3  max-md:p-10 max-md:justify-center max-xl:text-3xl text-6xl flex max-md:flex-row flex-col mr-[5%]"><span>	Capuccino </span> <span class="max-md:ml-2"> Cafe to...</span></div>
	...
	<div class="bg-white rounded-sm overflow-hidden flex flex-row-reverse max-sm:flex-col w-full relative mb-6 groupe hover:bg-[#A9957B] group">
			...
			<div class="flex min-w-72 max-md:w-full w-1/2 p-5 flex-col justify-between max-md:h-40  max-md:justify-center">
						...
						<div> 
								...
								<div class="self-stretch justify-start text-zinc-500 text-sm font-normal font-['Mulish'] leading-tight group-hover:text-white">łodkie stoły zachwycają bogactwem smaków i przepiękną aranżacją.</div>
						</div>
			</div>
	</div>
		...
		<div class="bg-white rounded-sm overflow-hidden flex flex-row-reverse max-sm:flex-col w-full relative mb-6 hover:bg-[#A9957B] group">
				<div class='w-1/2 max-md:w-full'>
					...
					<div class="flex min-w-72 max-md:w-full w-1/2 p-5 flex-col justify-between max-md:h-40 max-md:justify-center">
						...
						<div> 
								<div class="self-stretch justify-start text-stone-700 text-xl font-bold mb-1 group-hover:text-[#42352F]">PSklep online</div>
