...
<main>
	...
	<div class="heroSection bg-cover relative max-md:bg-center z-3 max-xl:bg-center max-lg:bg-top max-md:bg-contain bg-no-repeat !bg-cover">
		...
		<div class=" w-screen h-[100vh] flex items-center px-[5%] xl:px-[6%] relative">
			<div class="shadow w-full h-full absolute z-1  left-0"></div>

			<div class='  text-white relative z-2 w-full'>
				<!-- title -->
				...
				<div class='subsections  flex items-center  text-sm max-xl:text-[12px]  max-lg:text-[10px] max-md:w-full'>
					<div class='flex flex-wrap w-full justify-center gap-2 md:gap-8'>
						...
						<a href="<?php echo esc_url(page_url_by_slug('torty-okazjonalne')); ?>" class='features-sec max-md:mb-2 px-4 w-40 md:w-60 h-16 flex items-center justify-between'> <span>Torty okazjonalne</span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								<mask id="mask0_2040_1908" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
									<rect width="24" height="24" fill="#D9D9D9" />
								</mask>
								<g mask="url(#mask0_2040_1908)">
						...
						<a href="<?php echo esc_url(page_url_by_slug('slodkie-stoly')); ?>" class='features-sec max-md:mb-2 px-4 w-40 md:w-60 h-16 flex items-center justify-between'><span>Słodkie Stoły</span><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<a href="<?php echo esc_url(page_url_by_slug('menu')); ?>" class='features-sec max-md:mb-2 px-4 w-40 md:w-60 h-16 flex items-center justify-between'><span>Menu Kawiarnie</span><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<a href="<?php echo esc_url(get_permalink(wc_get_page_id('shop'))); ?>" class='features-sec max-md:mb-2 px-4 w-40 md:w-60 h-16 flex items-center justify-between'>Sklep online <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class='flex items-center justify-center relative h-[40vh] max-md:mt-4 mt-[10vh]'>
		<div class="relative max-2xl:w-[80%] max-lg:min-w-[90%]  max-2xl:min-w-[85%] max-w-[90vw]  max-sm:w-full max-md:min-w-[80%] max-h-[80vh] z-2 flex  justify-center items-center">
			...
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/resources/img/video_falback.jpg') " class="  object-cover  w-full z-2  !max-h-[70vh]">
		</div>
	</div>
	...
	<div class="services  max-md:h-auto  bg-cover  bg-center relative justify-center max-sm:p-[5%] max-md:bg-none pb-32 ">
		...
		<div class="relative text-center z-2">
