<div data-property-1="mobile 2" id="menuu" class="header z-[9999] h-[100px] flex items-center w-screen px-[5%] justify-between">
	...
	<div class="hidden md:flex">
		...
		wp_nav_menu([
			...
			'container'      => false,
			'items_wrap'     => '<div class="List text-sm px-2 inline-flex justify-start items-center gap-6">%3$s</div>', // no ul
						...
						<div class="p-8 inline-flex flex-col justify-start items-start gap-6">
							...
							<div class="inline-flex justify-start items-center gap-3">
								...
								<div data-property-1="Default" class="border-b border-zinc-800 flex justify-center items-center gap-2.5">
									<a href="<?php echo esc_url($register); ?>" class="justify-center !text-zinc-800 text-sm font-normal font-['Mulish'] leading-tight">Załóż konto teraz</a>
								</div>
							</div>
						</div>
					<?php endif; ?>
