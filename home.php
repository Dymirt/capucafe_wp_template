...
<main id="primary" class="site-main">
  ...
  <div class="self-stretch flex flex-col justify-start items-start">
    <div class="self-stretch min-w-56 pt-24 pb-44 bg-stone-200 inline-flex justify-center items-center gap-2.5">
    ...
    <!-- Cards grid -->
    <div class="self-stretch px-32 inline-flex justify-center items-start gap-10 flex-wrap content-start">

      <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        <article <?php post_class('flex-1 min-w-72 inline-flex flex-col justify-start items-start'); ?>>

          <a href="<?php the_permalink(); ?>" class="self-stretch h-56 py-4 inline-flex justify-center items-center gap-2.5">
          ...
          <div class="self-stretch flex flex-col justify-start items-start">
            ...
            <div class="self-stretch border-stone-400 flex flex-col justify-start items-center gap-2.5">
              <h2 class="self-stretch justify-start text-zinc-800 text-lg font-bold leading-relaxed">
