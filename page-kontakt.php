...
<main id="main" class="site-main">
	<div data-layer="div" class="Div w-full max-w-[768px] min-w-80 px-5 py-8 bg-stone-50 inline-flex flex-col justify-start items-start gap-3">
		...
		<div data-layer="Frame 115" class="Frame115 w-60 h-[522px] min-w-60 flex flex-col justify-start items-start">
	...
	<div data-layer="div" class="Div self-stretch min-w-80 px-5 pt-8 pb-20 bg-stone-200 inline-flex flex-col justify-start items-center gap-3">
