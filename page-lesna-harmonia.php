...
<main>
	<!-- hero section -->
	<div class="hero-lesna bg-cover relative max-md:bg-center z-3">
		...
		<div class="relative h-screen max-md:h-[70vh]   flex items-center justify-center">
			<div class="!text-white">
				<h1 class="!text-white !text-[80px] max-md:!text-[40px] !font-['Didot_LT_Pro']">Leśna Harmonia</h1>
				<p class="text-center">Idealna propozycja dla miłośników natury i rustykalnych klimatów</p>
			</div>
		</div>
	</div>
	...
	<div class="relative flex max-lg:h-auto h-[80vh] max-md:h-auto max-md:flex-col overflow-hidden">
		...
		<div class="w-1/2 h-full max-md:w-full ">
			<img class="w-full !h-full object-cover" src="<?php echo get_stylesheet_directory_uri(); ?>/resources/img/lesna_stol.jpg" />
		</div>
	</div>
