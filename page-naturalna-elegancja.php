...
<main>
<!-- hero section -->
<div class="hero-Naturalna relative h-screen max-md:h-[70vh] bg-cover max-md:bg-center flex items-center justify-center">
	...
	<div class=" pl-[5%] ">
		...
		<div id="productScrollWrapper" class="flex flex-nowrap overflow-x-auto scroll-smooth w-full ">
			<div id="productScroll" class="flex flex-nowrap snap-x snap-mandatory gap-5 pb-5">
						<img class="w-full max-md:h-auto max-h-[400px] object-cover lg:w-[90%]" src="<?php echo get_stylesheet_directory_uri(); ?>/resources/img/NaturalnaElegancj2.png" />
                        <img class="w-full max-md:h-auto max-h-[400px] object-cover lg:w-[90%]" src="<?php echo get_stylesheet_directory_uri(); ?>/resources/img/NaturalnaElegancj3.png" />
                        <img class="w-full max-md:h-auto max-h-[400px] object-cover lg:w-[90%]" src="<?php echo get_stylesheet_directory_uri(); ?>/resources/img/NaturalnaElegancj4.png" />
			</div>
		</div>
	</div>
</div>
...
<!-- Pozostałe (section) -->
    ...
    <div class="w-full flex justify-center items-center max-md:flex-col">
        ...
        <div class="flex-1  self-stretch w-1/2 max-md:w-full p-4 flex justify-center items-center max-md:justify-start gap-6  max-md:mb-4">
            <div class="p-4">
            <h4 class="w-full  justify-start !text-stone-400 !text-4xl font-['Didot_LT_Pro']">Różana Romantyka</h4>
