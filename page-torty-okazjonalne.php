...
<div id="torty_okazjonale_main_baner" class="bg-cover relative max-md:bg-center z-3 h-[760px]">
...
<div data-layer="Frame 137" class="Frame137 w-full self-stretch inline-flex flex-col justify-start items-center">
	<div data-layer="title" class="Title self-stretch py-20 inline-flex justify-center items-center gap-2.5">
		<div data-layer="Odkryj nasze torty weselne" class="OdkryjNaszeTortyWeselne flex-1 h-14 text-center justify-start text-stone-700 text-5xl font-normal font-['Didot_LT_Pro']"></div>
	</div>
	<div data-layer="01" class="w-full  max-h-[1260px] md:inline-flex justify-center items-center">
		<div data-layer="foto" class="Foto flex-1  max-w-[800px] max-h-[1044.37px] flex justify-start items-center gap-2.5">
			<img data-layer="image" class="Image flex-1 self-stretch" src="<?php echo get_stylesheet_directory_uri(); ?>/resources/img/torty_okazjonalne/komunijne.jpg" />
		</div>
		<div data-layer="txt" class="Txt flex-1 px-10 py-14 self-stretch max-w-[800px] backdrop-blur-lg inline-flex flex-col justify-center items-center gap-6">
			<div data-layer="Tort „Capuccino”" class="TortCapuccino w-full max-w-96 justify-start text-stone-400 text-4xl md:text-5xl font-normal font-['Didot_LT_Pro']">Torty komunijne</div>
			<div data-layer="wytworny, a zarazem delikatny tort pokryty masą cukrową z masłem kakaowym, idealnie komponuje się ze świeżymi kwiatami lub dekoracjami z masy" class="WytwornyAZarazemDelikatnyTortPokrytyMasCukrowZMasEmKakaowymIdealnieKomponujeSiZeWieYmiKwiatamiLubDekoracjamiZMasy w-full max-w-96 justify-start text-zinc-800 text-lg font-light font-['Mulish'] leading-relaxed">Pierwsza Komunia Święta to niezapomniana chwila w życiu dziecka i całej rodziny. W Capuccino Cafe oferujemy różnorodne warianty pysznych tortów idealnych na przyjęcia komunijne. Wykonujemy wypieki na zamówienie według pomysłu i aranżacji Klienta – wszystkie elementy dekoracyjne przygotowywane są ręcznie przez profesjonalnych artystów. Ponadto, z przyjemnością doradzimy w kwestii smaku i zapoznamy z naszymi dotychczasowymi realizacjami oraz projektami.
			</div>
			<div class="w-full max-w-96 justify-start text-stone-700 text-3xl font-normal font-['Didot_LT_Pro']"></div>
		</div>
	</div>
	<div data-layer="02" class="w-full  max-h-[1260px] flex flex-col md:flex-row justify-center items-center">
		<div data-layer="txt" class="Txt order-2 md:order-1 flex-1  px-10 py-14 self-stretch max-w-[800px] backdrop-blur-lg inline-flex flex-col justify-center items-center gap-6">
			<div data-layer="Tort art deco" class="TortArtDeco w-full max-w-96 justify-start text-stone-400 text-4xl md:text-5xl font-normal font-['Didot_LT_Pro']">Torty okazjonalne</div>
			<div class="w-full max-w-96 justify-start text-zinc-800 text-lg font-light font-['Mulish'] leading-relaxed">Urodziny, rocznice, baby shower – na każdą okazję stworzymy tort, który zachwyci wyglądem i smakiem. Od kolorowych projektów dla dzieci po wyrafinowane dekoracje dla dorosłych. Z nami zamienisz zwykłe świętowanie w słodkie wspomnienie!</div>
		</div>
		<div data-layer="foto" class="Foto  md:order-2 flex-1 max-w-[800px] max-h-[1044.37px] flex justify-start items-center gap-2.5">
			<img data-layer="malina-120x120 1" class="Malina120x1201 flex-1 self-stretch" src="<?php echo get_stylesheet_directory_uri(); ?>/resources/img/torty_okazjonalne/okazjonalne.png" />
		</div>
	</div>
	<div data-layer="03" class="w-full  max-h-[1260px] md:inline-flex justify-center items-center">
		<div data-layer="foto" class="Foto flex-1  max-w-[800px] max-h-[1044.37px] flex justify-start items-center gap-2.5">
			<img data-layer="image" class="Image flex-1 self-stretch" src="<?php echo get_stylesheet_directory_uri(); ?>/resources/img/torty_okazjonalne/firmowe.jpg" />
		</div>
		<div data-layer="txt" class="Txt flex-1 px-10 py-14 self-stretch max-w-[800px] backdrop-blur-lg inline-flex flex-col justify-center items-center gap-6">
			<div data-layer="Tort natura" class="TortNatura w-full max-w-96 justify-start text-stone-400 text-4xl md:text-5xl font-normal font-['Didot_LT_Pro']">Torty dla firm</div>
			<div class="w-full max-w-96 justify-start text-zinc-800 text-lg font-light font-['Mulish'] leading-relaxed">Torty reklamowe, jubileusze firmowe lub podziękowania dla klientów – nasze wypieki podkreślą wagę każdej biznesowej chwili. Możliwość umieszczenia logo, firmowych kolorów lub motywu branżowego. Dyskretna elegancja i dopracowane smaki dla wymagających gości.</div>
		</div>
	</div>
</div>
...
<div class="w-full self-stretch px-10 py-28 bg-stone-200 blur-[0px] inline-flex flex-col justify-start items-center gap-10">
	<div class="w-full max-w-[940px] flex flex-col justify-start items-start gap-4">
		<div class="self-stretch text-center justify-start text-stone-700 text-3xl md:text-5xl font-normal font-['Didot_LT_Pro']">Masz własny pomysł na design? </br>
			Zrealizujemy go! </div>
		<div class="self-stretch text-center justify-start text-stone-700 text-base mb:text-lg font-light font-['Mulish'] leading-relaxed">Od rodzinnych tradycji po najśmielsze wizje – stworzymy tort idealnie dopasowany do Twoich marzeń. </br><strong>Serdecznie zapraszamy do kontaktu!</strong></div>
	</div>
