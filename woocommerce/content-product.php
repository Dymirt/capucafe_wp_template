<div class="p-2 w-64 md:w-96 inline-flex flex-col justify-start items-start snap-start">
	...
	<div class="self-stretch flex flex-col justify-start items-start">
		...
		<div class="self-stretch inline-flex justify-start items-start gap-3 flex-wrap content-start">
			...
			<div class="h-12 min-w-12 p-4 bg-stone-400 rounded outline outline-1 outline-offset-[-1px] outline-stone-400 inline-flex flex-col justify-center items-center gap-2.5 md:hidden">
