<div data-property-1="Default" class="self-stretch w-full md:w-60 bg-white rounded inline-flex justify-center items-start group">
	<div class="flex-1 p-4 inline-flex flex-col justify-start items-start lg:group-hover:outline lg:group-hover:outline-1 lg:group-hover:outline-offset-[-1px] lg:group-hover:outline-[#A9957B]">
		...
		<div class="self-stretch h-32 flex flex-col justify-start items-start">
			<div class="self-stretch py-4 border-stone-400 flex flex-col justify-start items-center gap-2.5">
				<div class="self-stretch justify-start text-zinc-800 text-sm font-light font-['Mulish'] leading-relaxed"><?php the_title(); ?></div>
			</div>
			<div class="self-stretch h-12 inline-flex justify-start items-start gap-3 mt-auto">
				<div class="flex-1 self-stretch inline-flex flex-col justify-center items-start">
					<div class="self-stretch justify-start text-stone-700 text-3xl font-normal font-['Didot_LT_Pro']"><?php woocommerce_template_loop_price(); ?></div>
				</div>
				<a href="?add-to-cart=<?php the_ID(); ?>" data-layer="btn" class="Btn h-12 min-w-12 p-1 !bg-[#B1A08E] rounded-sm outline outline-1 outline-offset-[-1px] outline-stone-400 inline-flex flex-col justify-center items-center gap-2.5 lg:!hidden lg:group-hover:!inline-flex">
